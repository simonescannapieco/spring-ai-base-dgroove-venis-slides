...
\begin{frame}[t,fragile] \frametitle{Cronistoria della AI}
	...
	{\small
		\begin{itemize}[leftmargin=10pt,align=right]
			\onslide<1->\item[\alert{\faHandORight}] \alert{Nascita del WWW:} apre le porte alla \alert{democratizzazione dell'informazione}
			\begin{minipage}[t]{\textwidth}
				\begin{figure}[ht]
					\centering
					\includegraphics[width=.5\textwidth]{img/tim-berners-lee.png}
					{\tiny\\Tim Berners-Lee\\\textbf{Progetto WorldWideWeb - Nexus (Agosto 1991)}\\\vspace*{-4pt}\textit{\textcopyright CERN}}
				\end{figure}
			\end{minipage}
			\onslide<2-> \item[\alert{\faHandORight}] Per i nostalgici: \url{http://info.cern.ch}
		\end{itemize}
	}
\end{frame}
%
