...
\begin{frame}[t,fragile] \frametitle{Cronistoria della AI}
	...
	\begin{minipage}[t]{\textwidth}
		...
		\begin{minipage}[b]{0.55\textwidth}
			\centering
			\simplemedia{\vbox to 3cm{\vfil\hbox to 5cm{}\vfil}}{video/Humanoid-Robot-Goes-Berserk-During-Test-Run.mp4}{video/mp4}
			{\tiny\\Humanoid Robot Goes Berserk During Test Run\\\vspace*{-4pt}\textit{\textcopyright Youtube (\href{https://www.youtube.com/watch?v=m8VUrP5O048}{link video})}}
		\end{minipage}
	\end{minipage}
	}
	}
