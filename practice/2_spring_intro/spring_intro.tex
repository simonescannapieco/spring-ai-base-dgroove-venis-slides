...
\begin{frame}[t,fragile] \frametitle{API in Evoluzione}
	{\small
		...
		\epigraph{\textit{Spring AI è attualmente in versione 1.0.0 (GA). Sebbene l'API principale sia stabile, alcune funzionalità potrebbero cambiare nelle future versioni minor.}}{Considerazione per progetti enterprise}
		\end{center}
		}
	}
\end{frame}
