\section{\faWrench\ Custom prompt templates} % (fold)
...
\begin{frame}[t,fragile] \frametitle{Progetto Spring AI}
	...
	\begin{itemize}[leftmargin=10pt,align=right]
        ...
        \item[\alertedcircled{2}] Creazione \textit{file} \texttt{GeminiFromClientService.java} e \texttt{GeminiFromClientServiceImpl.java}
        \item[\alertedcircled{3}] Creazione \textit{file} \texttt{QuestionFromClientController.java}
...
\begin{frame}[t,fragile] \frametitle{Progetto Spring AI}
    \framesubtitle{Modello di richiesta}
        ...
        \end{itemize}
        \begin{block}{\textit{File} \texttt{resources/templates/get-custom-format-definition-prompt.st}}
			{\scriptsize\input{code/get-custom-format-definition-prompt.st}}
    	\end{block}
\end{frame}
%
\begin{frame}[t,fragile] \frametitle{Progetto Spring AI}
