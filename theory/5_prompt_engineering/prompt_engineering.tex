...
{\footnotesize
    \begin{minipage}[t]{\textwidth}
        \begin{itemize}[leftmargin=50pt,align=right]
            ...
            \begin{itemize}[leftmargin=15pt,align=right]
                \onslide<8->\item[\alert{\faArrowCircleRight}] Porre una domanda generica pertinente alla task finale
                \onslide<9->\item[\alert{\faArrowCircleRight}] Incapsulare la risposta in un nuovo prompt per modellare la task
