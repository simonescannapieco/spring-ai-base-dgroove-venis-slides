		...
		\begin{minipage}[t]{0.6\textwidth}
			\begin{itemize}[leftmargin=10pt,align=right]
				...
				\begin{itemize}[leftmargin=10pt,align=right]
					...
					\onslide<4->\item[\alert{\faArrowCircleRight}] Se non avete visto la serie, \textbf{\alert{pentitevi} e \alert{rimediate}}
				\end{itemize}
			\end{itemize}
		\end{minipage}
		%
	...
	\begin{minipage}[t]{\textwidth}
		\begin{minipage}[t]{0.6\textwidth}
			\begin{itemize}[leftmargin=10pt,align=right]
				...
				\onslide<4->\begin{itemize}[leftmargin=10pt,align=right]
								\item[\alert{\faArrowCircleRight}] John chiuso in una stanza con un programma che risponde a simboli cinesi passati sotto la porta
								\item[\alert{\faArrowCircleRight}] John non conosce il cinese, segue il programma che manipola i simboli, passa all'esterno le risposte
								\item[\alert{\faArrowCircleRight}] Le persone fuori dalla stanza pensano che John conosca il cinese!
				\end{itemize}
		...
		\end{minipage}
		\begin{center}
			\href{https://plato.stanford.edu/entries/chinese-room/}{\faExternalLinkSquare\ Maggiori informazioni}
		\end{center}
	\end{minipage}
}
\end{frame}
