...
\begin{frame}[t,fragile] \frametitle{Cronistoria della AI}
	...
	\begin{minipage}[t]{\textwidth}
		\begin{minipage}[b]{0.4\textwidth}
			\begin{figure}[ht]
				\includegraphics[height=4.5cm,keepaspectratio]{img/Deep_Blue.jpg}
		...
		\begin{minipage}[b]{0.55\textwidth}
			...
			\presentvideo{img/Humanoid-Robot-Goes-Berserk-During-Test-Run-thumbnail.png}{video/Humanoid-Robot-Goes-Berserk-During-Test-Run.mp4}
	...
	\begin{minipage}[t]{\textwidth}
		\begin{minipage}[b]{0.25\textwidth}
			\centering
			\begin{figure}[ht]
				\includegraphics[height=3.5cm,keepaspectratio]{img/Edward-Feigenbaum-crop.png}
		...
		\begin{minipage}[b]{0.25\textwidth}
			\centering
			\begin{figure}[ht]
				\includegraphics[height=3.5cm,keepaspectratio]{img/Dr-House.png}
		...
		\begin{minipage}[b]{0.45\textwidth}
			\centering
			\begin{figure}[ht]
				\includegraphics[height=3.5cm,keepaspectratio]{img/XSEL-XCON-no-bg-explained.png}
...
\begin{frame}[t,fragile] \frametitle{Cronistoria della AI}
	...
	\only<1|handout:1>{
		\begin{minipage}[t]{\textwidth}
			\begin{figure}[ht]
				\centering
				\includegraphics[width=.5\textwidth]{img/vgg-16-image-no-bg.png}
		...
		\begin{minipage}[t]{\textwidth}
			\begin{minipage}[b]{0.33\textwidth}
				\centering
				\begin{figure}[ht]
					\includegraphics[width=.6\textwidth]{img/Geoffrey-Hinton.jpeg}
	...
	\only<3|handout:3>{
		\begin{figure}[ht]
        	\centering
        	\includegraphics[width=.8\textwidth]{img/neural-networks-chart-alpha-rearranged.png}
    	\end{figure}
		\begin{flushright}
    		\vspace*{-10pt}
	...
	{\small
		...
		\begin{minipage}[t]{\textwidth}
			\begin{minipage}[b]{0.45\textwidth}
				...
				\begin{figure}[ht]
					\centering
					\includegraphics[height=3.5cm,keepaspectratio]{img/Paul-Werbos.jpg}
			...
			\begin{minipage}[b]{0.45\textwidth}
				\centering
				\begin{figure}[ht]
					\includegraphics[height=3.5cm,keepaspectratio]{img/VisionTek_GeForce_256_rotated.png}
	...
	{\small
		...
		\begin{center}
			\begin{minipage}[b]{.45\textwidth}
				\begin{figure}[ht]
					\centering
					\includegraphics[width=\textwidth]{img/tim-berners-lee.png}
		...
		\begin{center}
			\begin{minipage}[b]{.6\textwidth}
				\begin{figure}[ht]
					\centering
					\includegraphics[width=\textwidth]{img/global-data-generated-annually-alpha.png}
				\end{figure}
				\begin{flushright}
                	\vspace*{-10pt}
		...
		\begin{center}
			\begin{minipage}[b]{.6\textwidth}
				\begin{figure}[ht]
					\centering
					\includegraphics[width=\textwidth]{img/global-data-generated-annually-alpha-numbers.png}
				\end{figure}
				\begin{flushright}
                	\vspace*{-10pt}
                	{\tiny\textit{\textcopyright explodingtopics.com}}
...
\end{frame}
%
\section{Intelligenza Artificiale: Debole vs Forte} % (fold)
\label{sec:ai_types}
%
\begin{frame}[t,fragile] \frametitle{Intelligenza Artificiale}
	{\scriptsize
		\onslide<1->
            ...
            \vspace*{-15pt}
             \begin{minipage}[t]{\textwidth}
             	%\begin{figure}[ht]
                %    \centering
                %    \includegraphics[width=\textwidth]{img/AI-paradigms-timeline.png}
                %\end{figure}
            \end{minipage}
            \\\vspace*{3pt}
	    	\begin{minipage}[t]{\textwidth}
            	...
            	\begin{minipage}[t]{0.4\textwidth}
                	\centering
                	%\begin{figure}[ht]
                    %	\includegraphics[width=.8\textwidth]{img/ai-evolution.png}
		...
		\onslide<1->
	    	...
	    	\begin{minipage}[t]{\textwidth}
            	...
            	\begin{minipage}[t]{0.4\textwidth}
                	\centering
                	%\begin{figure}[ht]
                    %	\includegraphics[width=.8\textwidth]{img/narrow-ai-examples.png}
...
\}}}{Esempio Spring Boot per analisi sentiment}
			...
			\begin{minipage}[t]{0.35\textwidth}
				\centering
				%\begin{figure}[ht]
				%	\includegraphics[width=.8\textwidth]{img/sentiment-analysis.png}
...
\}}}{Chatbot tradizionale (regole fisse)}
			...
			\begin{minipage}[t]{0.35\textwidth}
				\centering
				%\begin{figure}[ht]
				%	\includegraphics[width=.8\textwidth]{img/chatbot-rules.png}
...
\}}}{Sistema di rilevamento frodi basato su ML}
			...
			\begin{minipage}[t]{0.35\textwidth}
				\centering
				%\begin{figure}[ht]
				%	\includegraphics[width=.8\textwidth]{img/fraud-detection.png}
...
\}}}{Pricing dinamico basato su AI}
			...
			\begin{minipage}[t]{0.35\textwidth}
				\centering
				%\begin{figure}[ht]
				%	\includegraphics[width=.8\textwidth]{img/dynamic-pricing.png}
		...
		\onslide<1->
	    	...
	    	\begin{minipage}[t]{\textwidth}
            	...
            	\begin{minipage}[t]{0.4\textwidth}
                	\centering
                	%\begin{figure}[ht]
                    % 	\includegraphics[width=.8\textwidth]{img/agi-concept.png}
	...
	{\small
		...
		\begin{minipage}[t]{\textwidth}
			...
			\begin{minipage}[t]{0.35\textwidth}
				\centering
				%\begin{figure}[ht]
				%	\includegraphics[width=.8\textwidth]{img/universal-programmer.png}
		...
		\begin{minipage}[t]{\textwidth}
			...
			\begin{minipage}[t]{0.35\textwidth}
				\centering
				%\begin{figure}[ht]
				%	\includegraphics[width=.8\textwidth]{img/general-problem-solver.png}
		...
		\begin{minipage}[t]{\textwidth}
			...
			\begin{minipage}[t]{0.35\textwidth}
				\centering
				%\begin{figure}[ht]
				%	\includegraphics[width=.8\textwidth]{img/rapid-learning.png}
		...
		\begin{minipage}[t]{\textwidth}
			...
			\begin{minipage}[t]{0.35\textwidth}
				\centering
				%\begin{figure}[ht]
				%	\includegraphics[width=.8\textwidth]{img/causal-reasoning.png}
